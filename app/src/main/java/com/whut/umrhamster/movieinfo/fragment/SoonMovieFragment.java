...
public class SoonMovieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_movie_soon,container,false);
        initView(rootView);
    ...
    private void initView(View view){
        refreshLayout = view.findViewById(R.id.movie_soon_srl);
        recyclerView = view.findViewById(R.id.movie_soon_rv);
